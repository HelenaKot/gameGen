...
public class BlocksExpendableList {
    ...
    private void setChildData() {
        BlockPatternHolder[] projectPatterns = {
                ...
                new BlockPatternHolder(new BlockActorPattern("set screen", new BlockData(new InputFragment[]{
                        new InputFragment(InputType.VARIABLE, "set screen to").setExpectedValue(ValueType.SCREEN)},
                        BlockShape.CHAIN_METHOD).setExpectedMethod(MethodType.SCREEN_SWAPPER), Color.PURPLE)),
        };
        childItems.add(projectPatterns);
        ...
        BlockPatternHolder[] tilesPatterns = {
                ...
                new BlockPatternHolder(new BlockActorPattern("spawn tile at", new BlockData(new InputFragment[]{
                ...
                new BlockPatternHolder(new BlockActorPattern("change color", new BlockData(new InputFragment[]{
                        new InputFragment(InputType.VARIABLE, "change color to").setExpectedValue(ValueType.COLOR)},
                        BlockShape.CHAIN_METHOD), Color.ORANGE)),
        };
        ...
        BlockPatternHolder[] constantsPatterns = {
                ...
                new BlockPatternHolder(new BlockActorPattern("screen ", new BlockData(new InputFragment[]{
                        new InputFragment(InputType.DUMMY, "0")}, BlockShape.VARIABLE), Color.SKY), DialogSpawner.DIALOG_SCREEN),
        };
        childItems.add(constantsPatterns);
        ...
        BlockPatternHolder[] getterPatterns = {
                new BlockPatternHolder(new BlockActorPattern("get tile at", new BlockData(new InputFragment[]{
                        new InputFragment(InputType.DUMMY, "do for tile"),
                        new InputFragment(InputType.VARIABLE, "at x").setExpectedValue(ValueType.INT_NUMBER),
                        new InputFragment(InputType.VARIABLE, "at y").setExpectedValue(ValueType.INT_NUMBER),
                        new InputFragment(InputType.SOCKET, "CHANGE_CONTEXT_SOCKET").setExpectedValue(ValueType.METHOD),},
                        BlockShape.CHAIN_METHOD).setExpectedMethod(MethodType.BLOCK_GETTER), Color.ORANGE)),
